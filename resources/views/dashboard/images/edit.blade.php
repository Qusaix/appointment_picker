...
@section('section')
    ...
    <div class="card shadow mb-4">
        <div class="card-body p-4">
            ...
            @endif    
            <form method="POST" action="{{route('dashboard.images.update',$image->id)}}">
                @csrf
                <div class="form-group">
                  <label for="exampleInputEmail1">Image Link</label>
                  <input name="link" value="{{(old('image')?old('image'):$image->link)}}" type="text" class="form-control" id="image" aria-describedby="image" placeholder="https://www.imgbb.com/YourImageLink.png">
