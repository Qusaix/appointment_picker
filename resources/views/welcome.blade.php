...
<body>
  ...
  <!-- Vendor JS Files -->
  <script defer src='{{asset('fullcalendar/main.js')}}'></script>
  ...
  <script defer src="{{asset('assets/vendor/waypoints/jquery.waypoints.min.js')}}"></script>
  <script defer src="{{asset('assets/vendor/counterup/counterup.min.js')}}"></script>
  <script defer src="{{asset('assets/vendor/isotope-layout/isotope.pkgd.min.js')}}"></script>
  <script defer src="{{asset('assets/vendor/venobox/venobox.min.js')}}"></script>
  <script defer src="{{asset('assets/vendor/owl.carousel/owl.carousel.min.js')}}"></script>
  <script defer src="{{asset('assets/vendor/typed.js/typed.min.js')}}"></script>
